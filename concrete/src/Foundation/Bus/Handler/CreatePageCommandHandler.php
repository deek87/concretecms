...
use Concrete\Core\Foundation\Bus\Command\Page\CreatePageCommand;
 ...
 */
class CreatePageCommandHandler extends AbstractCommandHandler
{
    /** @var CreatePageCommand $command */
    protected $command;
    ...
    public function handle(CreatePageCommand $createPageCommand) {
        $this->command = $createPageCommand;
        ...
        if (is_object($pageDraft) && !$pageDraft->isError()) {
            ...
            $createPageCommand->setReturnObject($pageDraft);
